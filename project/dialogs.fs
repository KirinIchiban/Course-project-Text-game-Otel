...
let welcome : Dialog<unit> = dialog {
    ...
    do! writeLine "Постояльцы отеля:"
    do! writeLine "  Алек Сневар - владелец отеля и всей долины"
    do! writeLine "  Кайса - кухарка и горничная"
    do! writeLine "  Симон Симонэ - учёный-физик с мировым именем, скалолаз"
    do! writeLine "  Дю Барнстокр - известный иллюзионист, шутник-мистификатор"
    do! writeLine "  Брюн - дитя Дю Барнстокра, вечно язвительное и вечно в солнцезащитных очках"
    do! writeLine "  Хинкус - невзрачный человек в шубе, ходатай по делам несовершеннолетних"
    do! writeLine "  Мозес - богатый постоялец с чудаковатым характером"
    do! writeLine "  Госпожа Мозес - красавица-жена с диадемой на голове, мила и молчалива"
    do! writeLine "  Луарвик Л. Луарвик - ..."
    do! writeLine "  Олаф - постоялец со скандинавской внешностью, широкоплеч и хорош во всем\n"
    ...
    do! writeLine "  положить <предмет> - Оставить предмет в текущей локации"
    ...
    do! writeLine "  расследовать    - проанализировать все науйденные улики"
...
let talkTo characterName : Dialog<Result<string, string>> = dialog {
    ...
    | Some loc when loc = state.Location ->
        ...
        let dialogText = 
            ...
            | "Алек Сневар" ->
                "Алек Сневар (хозяин отеля): \"А, Петер! Странные дела " +
                "творятся в моем отеле. Трубка курит сама, вещи пропадают, " +
                "а теперь это... Я всегда чувствовал, что дух " +
                "Погибшего Альпиниста не покинул эти стены.\""

            | "Хинкус" ->
                "Хинкус (дрожит): \"Он... он пришел сзади. Я видел его " +
                "раньше, днем. Но говорить не буду! Не заставьте меня! " +
                "Лучше убейте сразу, а еще лучше налейте бренди!\" " +
                "На шее у Хинкуса свежие синяки."

            | "Кайса" ->
                "Кайса (краснея): \"Ой, господин инспектор! Я ничего не " +
                "знаю! Только вот ожерелье мое пропало, и кто-то в моей " +
                "постели валялся... И следы мокрые в коридоре видела...\""

            | "Луарвик Л. Луарвик" ->
                "Луарвик Л. Луарвик (косоглазый, однорукий): \"Я имею дело " +
                "с Олафом Андварафорс. Он должен вернуть то, что взял. " +
                "Комендант двести двадцать четыре.\" Он говорит монотонно, " +
                "как запрограммированный."
            | "Симонэ" ->
...
let interrogate characterName : Dialog<Result<string, string>> = dialog {
    ...
    | Some loc when loc = state.Location ->
        ...
        let interrogateText = 
            ...
            | "Мозес" when not state.AllCluesCollected ->
                "Мозес: \"Мне нечего вам сказать, инспектор, где мои часы, почему вы прохлаждаетесь как госслужащий.\""
            | "Мозес" when not state.SafeHasCase ->
                "Мозес: \"Сначала обезопасьте чемодан, инспектор. Тогда поговорим.\""
